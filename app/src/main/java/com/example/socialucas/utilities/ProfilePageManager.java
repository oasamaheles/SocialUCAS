package com.example.socialucas.utilities;
...
import com.example.socialucas.adapters.MyPostsUcasAdapter;
import com.example.socialucas.adapters.MyPictureAdapter;
...
public class ProfilePageManager {
    ...
    MyPostsUcasAdapter myPostsUcasAdapter;
    ...
    private void handlePostsArea() {
        ...
        myPostsUcasAdapter = new MyPostsUcasAdapter(context);
        ...
        kittsButton.setOnClickListener(v -> {
            recyclerViewMyPosts.setAdapter(myPostsUcasAdapter);
            ...
            for (DocumentReference postReference : user.getPosts()) {
                postReference.get().addOnSuccessListener(postSnapshot -> {
                    ...
                    if (!post.getKitt().isEmpty()) {
                        myPostsUcasAdapter.addPost(postReference);
                    }
                });
            }
        });
