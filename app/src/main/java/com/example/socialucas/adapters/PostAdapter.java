...
import com.example.socialucas.activities.CommentsActivity;
...
import com.example.socialucas.utilities.DateFormatter;
import com.example.socialucas.utilities.NotificationManager;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        db.collection("Users").document(post.getCreator()).get().addOnSuccessListener(snapshot -> {
            ...
            Glide.with(mContext).load(creator.getProfileImageUrl())
        ...
        holder.image.setText(post.getKitt());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView username, noOfLikes, caption, image, commentCount, time;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            image = itemView.findViewById(R.id.txt_kitt);
